...
es una vulnerabilidad de control de acceso que ocurre cuando una aplicación permite acceder a recursos mediante referencias o identificadores sin verificar correctamente si el usuario tiene autorización para acceder a ellos.
